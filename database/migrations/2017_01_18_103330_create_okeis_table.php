...
class CreateOkeisTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('okeis')->insert(array('id'=>796,'name'=>'Штук','shortname'=>'шт.','html'=>'шт.'),array('id'=>'18','name'=>'Погонный метр','shortname'=>'пог. м.','html'=>'пог. м.'),array('id'=>'839','name'=>'Комплект','shortname'=>'компл.','компл.'));
    }

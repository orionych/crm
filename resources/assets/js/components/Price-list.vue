    ...
    <div class="container" style='width:100%'>
        <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">Прайс-лист: <input type='text' v-model='code' @keyup='priceLoad(), loading=true'  /><i class="fa fa-spinner fa-spin fa-fw"></i>{{ code }} - {{ equipments.length }} </div>
